...
import Timeslot from './AdminPannel/Timeslot'
      ...
      <div>
        <BrowserRouter>
          ...
          <Switch>
            ...
            <AdminRoute path='/admin/get/orders/history' exact component={Adminpannel(Orderhistory)} />
            ...
            <AdminRoute path='/admin/get/timeslot' exact component={Adminpannel(Timeslot)} />
